...
final class TraceCollector {
    ...
    let queue = DispatchQueue(label: "vgsilentauth.tracecollector.queue")
    ...
    func addDebug(type: OSLogType = .debug, tag: String? = "VGSilentAuth", log: String) {
        queue.async {
...
public class DebugInfo {
    ...
    public func userAgent(sdkVersion: String) -> String {
        return "VonageClientSDKSilentAuth/\(sdkVersion) \(deviceString())"
    }
